    ...
    <section id="expertise" className="py-16 md:py-24">
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          ...
          applications mobiles performantes, évolutives et adaptées à vos
          besoins spécifiques.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-black-light p-6 rounded-xl shadow-lg">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Créez des applications visuellement attrayantes avec des
              animations fluides grâce à Flutter. Ce framework de Google permet
              de développer des interfaces utilisateur cohérentes sur toutes les
              plateformes.
            </p>
            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="flex items-center gap-2">
