...
export default function DevSurMesure() {
  ...
  const techItems = [
    ...
    },
    {
      title: "Next.js",
      description:
        "Création de sites web performants et SEO-friendly avec rendu côté serveur et génération statique pour une expérience utilisateur optimale.",
      icon: mounted ? (
        <NextJsIcon color={isDark ? "#fdb827" : "#3232FC"} />
      ) : (
    ...
    },
    {
      title: "TypeScript",
      description:
        "Développement de code robuste et maintenable avec un typage fort pour réduire les erreurs et faciliter la maintenance à long terme.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
